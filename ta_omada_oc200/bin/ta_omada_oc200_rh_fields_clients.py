...
clients input. Given the currently-selected account (passed as a dependency query param
...
class OmadaFieldsClientsHandler(admin.MConfigHandler):
    def setup(self):
...
if __name__ == "__main__":
    admin.init(OmadaFieldsClientsHandler, admin.CONTEXT_NONE)
