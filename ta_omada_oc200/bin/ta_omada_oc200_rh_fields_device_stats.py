...
device_stats input. Given the currently-selected account (passed as a dependency query param
...
SERVICE = "device_stats"
REQUIRED = REQUIRED_FIELDS_BY_SERVICE.get(SERVICE, set())


class OmadaFieldsDeviceStatsHandler(admin.MConfigHandler):
    def setup(self):
    ...
    def handleList(self, confInfo):
        ...
        logger = logger_for_input("fields_picker_device_stats")
        try:
...
if __name__ == "__main__":
    admin.init(OmadaFieldsDeviceStatsHandler, admin.CONTEXT_NONE)
