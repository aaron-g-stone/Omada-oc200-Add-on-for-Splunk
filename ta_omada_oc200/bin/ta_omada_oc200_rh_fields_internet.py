...
internet input. Given the currently-selected account (passed as a dependency query param
...
class OmadaFieldsInternetHandler(admin.MConfigHandler):
    def setup(self):
    ...
    def handleList(self, confInfo):
        ...
        logger = logger_for_input("fields_picker_internet")
        try:
...
if __name__ == "__main__":
    admin.init(OmadaFieldsInternetHandler, admin.CONTEXT_NONE)
