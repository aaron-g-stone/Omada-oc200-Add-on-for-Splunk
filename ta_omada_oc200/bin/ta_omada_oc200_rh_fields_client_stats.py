...
client_stats input. Given the currently-selected account (passed as a dependency query param
...
SERVICE = "client_stats"
REQUIRED = REQUIRED_FIELDS_BY_SERVICE.get(SERVICE, set())


class OmadaFieldsClientStatsHandler(admin.MConfigHandler):
    def setup(self):
    ...
    def handleList(self, confInfo):
        ...
        logger = logger_for_input("fields_picker_clients")
        try:
...
if __name__ == "__main__":
    admin.init(OmadaFieldsClientStatsHandler, admin.CONTEXT_NONE)
